...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouterPortInfo) DeepCopyInto(out *RouterPortInfo) {
	*out = *in
	if in.InternalUUID != nil {
		in, out := &in.InternalUUID, &out.InternalUUID
		*out = new(types.UID)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouterPortInfo.
func (in *RouterPortInfo) DeepCopy() *RouterPortInfo {
	if in == nil {
		return nil
	}
	out := new(RouterPortInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RouterStatus) DeepCopyInto(out *RouterStatus) {
	*out = *in
	...
	if in.Ports != nil {
		...
		*out = make([]RouterPortInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
